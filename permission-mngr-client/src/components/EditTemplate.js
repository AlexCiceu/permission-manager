...
// Normally I would make this combined with NewTemplate in one new/edit form, would be one of the things I'd refactor
const EditTemplate = ({
	open,
	setOpen,
	...
	const [newTemplate, setNewTemplate] = useState(templateInfo);
	const [permissionName, setPermissionName] = useState([]);

	// Maybe inefficient due to re-rendering the component again, should take another look
	useEffect(() => {
		setNewTemplate(templateInfo);
		setPermissionName(templateInfo?.permissions || []);
	}, [templateInfo]);
